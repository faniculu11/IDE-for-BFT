...
<button class="w3-btn w3-left " onclick="myFunction()"><img class= "w3-center" width = "95%"  src="https://img.icons8.com/color/48/000000/light.png"/></button>
	...
	<h3 class= "w3-center">Task 1.3 a</h3>
	<?php 
...
alert('Oops your aunt must have asked someone to insert that record already. Press okay to delete the record so you can practice inserting it yourself');
	...
	mysqli_query($conn,"DELETE FROM Gauteng_Treatments WHERE PatientID = 21");
...
<button class='w3-btn w3-right w3-green w3-text-black ' name= "next" >Task 1.1.3 b-></button>
...
<?php } 
 ...
 Write the insert SQL code to insert the Bryanston Treatments table data into the Gauteng_Treatments table. Start with PatientID 21. <br>
...
function myFunction1() {
  alert("INSERT INTO Gauteng_Treatments (PatientID,BloodType,RecoveringStatus) VALUES (21,'B','No')");
}
</script>
