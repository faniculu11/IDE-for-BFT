...
<button class="w3-btn w3-left " onclick="myFunction()"><img class= "w3-center" width = "95%"  src="https://img.icons8.com/color/48/000000/light.png"/></button>
	...
	<h3 class= "w3-center">Task 1.1 b</h3>
	<?php 
...
alert('Wrong value for CodeName, the correct CodeName value is BY ');
...
alert('Wrong value for AgeGroup, the correct AgeGroup value is 40-50');
...
alert('Oops your aunt must have asked someone to insert that record already. Press okay to delete the record so you can practice inserting it yourself');
	  ...
	  mysqli_query($conn,"DELETE FROM Gauteng_Patients WHERE PatientID = 22"); 
} 
...
<br><br>
	 ...
	 Now add PatientID 22, using the insert SQL code. 
 <br>
