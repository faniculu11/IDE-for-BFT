...
alert('Wrong value for BloodType, the correct BloodType value is AB ');
...
window.location.replace('task13.php');
	...
	C. Write the INSERT SQL code to insert the Bryanston_Deaths data into the Gauteng_Deaths table. 
<br>
