...
<button class="w3-btn w3-left " onclick="myFunction()"><img class= "w3-center" width = "95%"  src="https://img.icons8.com/color/48/000000/light.png"/></button>
	...
	<h3 class= "w3-center">Task 1.1 a</h3>
	<?php 
...
alert('Wrong value for CodeName, the correct CodeName value is BX ');
...
alert('Wrong value for OtherDiseases, the correct OtherDiseases value is No  ');
...
alert('Oops your aunt must have asked someone to insert that record already. Press okay to delete the record so you can practice inserting it yourself');
	  ...
	  mysqli_query($conn,"DELETE FROM Gauteng_Patients WHERE PatientID = 21"); 
} 
...
<button class='w3-btn w3-right w3-green w3-text-black ' name= "next" >Task 1.1.b-></button>
...
<br><br>
	...
	Now Write the INSERT SQL code to insert the Bryanston Patient of PatientID 21 into the Gauteng_Patients table. 
 <br>
...
function myFunction1() {
  alert("INSERT INTO Gauteng_Patients (PatientID,CodeName,AgeGroup,OtherDiseases,Suburb) VALUES (21,'BX','20-30','No','Bryanston')");
}
</script>
